...
const OrbituarySchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "http://localhost:3000/orbituary/",
      url: "http://localhost:3000/orbituary/",
      name: "SpiritualHome - Orbituary",
      isPartOf: { "@id": "http://localhost:3000/#website" },
      primaryImageOfPage: {
        "@id": "http://localhost:3000/orbituary/#primaryimage",
      },
      image: { "@id": "http://localhost:3000/orbituary/#primaryimage" },
      thumbnailUrl: "http://localhost:3000/Orbituary.jpg",
      breadcrumb: {
        "@id": "http://localhost:3000/orbituary/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "http://localhost:3000/orbituary/#primaryimage",
      url: "http://localhost:3000/Orbituary.jpg",
      contentUrl: "http://localhost:3000/Orbituary.jpg",
      width: 1280,
      height: 720,
    },
    {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" "
        />
        <link rel="canonical" href="http://localhost:3000/orbituary" />
        <meta
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/orbituary"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="http://localhost:3000/Orbituary.jpg"
        />
