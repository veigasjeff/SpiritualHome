...
const AdorationSchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "http://localhost:3000/adoration/",
      url: "http://localhost:3000/adoration/",
      name: "SpiritualHome - Adoration",
      isPartOf: { "@id": "http://localhost:3000/#website" },
      primaryImageOfPage: {
        "@id": "http://localhost:3000/adoration/#primaryimage",
      },
      image: { "@id": "http://localhost:3000/adoration/#primaryimage" },
      thumbnailUrl: "http://localhost:3000/Adoration.jpg",
      breadcrumb: {
        "@id": "http://localhost:3000/adoration/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "http://localhost:3000/adoration/#primaryimage",
      url: "http://localhost:3000/Adoration.jpg",
      contentUrl: "http://localhost:3000/Adoration.jpg",
      width: 1280,
      height: 720,
    },
    {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" "
        />
        <link rel="canonical" href="http://localhost:3000/adoration" />
        <meta
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/adoration"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="http://localhost:3000/Adoration.jpg"
        />
