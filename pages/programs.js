...
const ProgramsSchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "http://localhost:3000/programs/",
      url: "http://localhost:3000/programs/",
      name: "SpiritualHome - Programs",
      isPartOf: { "@id": "http://localhost:3000/#website" },
      primaryImageOfPage: {
        "@id": "http://localhost:3000/programs/#primaryimage",
      },
      image: { "@id": "http://localhost:3000/programs/#primaryimage" },
      thumbnailUrl: "http://localhost:3000/Programs.jpg",
      breadcrumb: {
        "@id": "http://localhost:3000/programs/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "http://localhost:3000/programs/#primaryimage",
      url: "http://localhost:3000/Programs.jpg",
      contentUrl: "http://localhost:3000/Programs.jpg",
      width: 1280,
      height: 720,
    },
    {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" "
        />
        <link rel="canonical" href="http://localhost:3000/programs" />
        <meta
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/programs"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="http://localhost:3000/Programs.jpg"
        />
