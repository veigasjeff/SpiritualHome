...
const WeddingCeremonySchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "http://localhost:3000/wedding-ceremony/",
      url: "http://localhost:3000/wedding-ceremony/",
      name: "SpiritualHome - Wedding Ceremony",
      isPartOf: { "@id": "http://localhost:3000/#website" },
      primaryImageOfPage: {
        "@id": "http://localhost:3000/wedding-ceremony/#primaryimage",
      },
      image: { "@id": "http://localhost:3000/wedding-ceremony/#primaryimage" },
      thumbnailUrl: "http://localhost:3000/Wedding_Ceremony.jpg",
      breadcrumb: {
        "@id": "http://localhost:3000/wedding-ceremony/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "http://localhost:3000/wedding-ceremony/#primaryimage",
      url: "http://localhost:3000/Wedding_Ceremony.jpg",
      contentUrl: "http://localhost:3000/Wedding_Ceremony.jpg",
      width: 1280,
      height: 720,
    },
    {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" "
        />
        <link rel="canonical" href="http://localhost:3000/wedding-ceremony" />
        <meta
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/wedding-ceremony"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="http://localhost:3000/Wedding_Ceremony.jpg"
        />
