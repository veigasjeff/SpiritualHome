...
import DailyMass from "../components/DailyMass";
import styles from '../styles/Home.module.css';
import QuoteOfTheDay from "../components/QuoteOfTheDay";

const DailyMassSchema = JSON.stringify({
  "@context": "https://schema.org",
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "https://spiritualhome.vercel.app/daily-mass/",
      url: "https://spiritualhome.vercel.app/daily-mass/",
      name: "SpiritualHome - Daily Mass",
      isPartOf: { "@id": "https://spiritualhome.vercel.app/#website" },
      primaryImageOfPage: {
        "@id": "https://spiritualhome.vercel.app/daily-mass/#primaryimage",
      },
      image: { "@id": "https://spiritualhome.vercel.app/daily-mass/#primaryimage" },
      thumbnailUrl: "https://spiritualhome.vercel.app/Daily_Mass.jpg",
      breadcrumb: {
        "@id": "https://spiritualhome.vercel.app/daily-mass/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "https://spiritualhome.vercel.app/daily-mass/#primaryimage",
      url: "https://spiritualhome.vercel.app/Daily_Mass.jpg",
      contentUrl: "https://spiritualhome.vercel.app/Daily_Mass.jpg",
      width: 1280,
      height: 720,
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "SpiritualHome - Daily Mass" },
      ],
    },
    {
      "@type": "WebSite",
...
export default function Home() {
  return (
    <>
      <Head>
        <title>SpiritualHome - Daily Mass</title>
        <link
          rel="sitemap"
        ...
        />
        <link rel="canonical" href="https://spiritualhome.vercel.app/daily-mass" />
        <meta
        ...
        <meta
          property="og:title"
          content="SpiritualHome - Daily Mass"
        />
        <meta
          property="og:url"
          content="https://spiritualhome.vercel.app/daily-mass"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://spiritualhome.vercel.app/Daily_Mass.jpg"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: DailyMassSchema }}
        />
        <script
          async
