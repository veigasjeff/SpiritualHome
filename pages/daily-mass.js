...
const DailyMassSchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "http://localhost:3000/daily-mass/",
      url: "http://localhost:3000/daily-mass/",
      name: "SpiritualHome - Daily Mass",
      isPartOf: { "@id": "http://localhost:3000/#website" },
      primaryImageOfPage: {
        "@id": "http://localhost:3000/daily-mass/#primaryimage",
      },
      image: { "@id": "http://localhost:3000/daily-mass/#primaryimage" },
      thumbnailUrl: "http://localhost:3000/Daily_Mass.jpg",
      breadcrumb: {
        "@id": "http://localhost:3000/daily-mass/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "http://localhost:3000/daily-mass/#primaryimage",
      url: "http://localhost:3000/Daily_Mass.jpg",
      contentUrl: "http://localhost:3000/Daily_Mass.jpg",
      width: 1280,
      height: 720,
    },
    {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" "
        />
        <link rel="canonical" href="http://localhost:3000/daily-mass" />
        <meta
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/daily-mass"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="http://localhost:3000/Daily_Mass.jpg"
        />
