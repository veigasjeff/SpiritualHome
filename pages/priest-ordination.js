...
const PriestOrdinationSchema = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "CollectionPage",
      "@id": "http://localhost:3000/priest-ordination/",
      url: "http://localhost:3000/priest-ordination/",
      name: "SpiritualHome - Priest Ordination",
      isPartOf: { "@id": "http://localhost:3000/#website" },
      primaryImageOfPage: {
        "@id": "http://localhost:3000/priest-ordination/#primaryimage",
      },
      image: { "@id": "http://localhost:3000/priest-ordination/#primaryimage" },
      thumbnailUrl: "http://localhost:3000/Priest_Ordination.jpg",
      breadcrumb: {
        "@id": "http://localhost:3000/priest-ordination/#breadcrumb",
      },
      inLanguage: "en-US",
    },
    {
      ...
      inLanguage: "en-US",
      "@id": "http://localhost:3000/priest-ordination/#primaryimage",
      url: "http://localhost:3000/Priest_Ordination.jpg",
      contentUrl: "http://localhost:3000/Priest_Ordination.jpg",
      width: 1280,
      height: 720,
    },
    {
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content=" "
        />
        <link rel="canonical" href="http://localhost:3000/priest-ordination" />
        <meta
        ...
        <meta
          property="og:url"
          content="http://localhost:3000/priest-ordination"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="http://localhost:3000/Priest_Ordination.jpg"
        />
